...
class EV_Generator(nn.Module):
    ...
    def group_rels(self, l2r, rpred_types, rpred_ids, etypes):
        ...
        # flat_rels_group is a defaultdict where the key is represented by
        ...
        # loop over all existing relations (pairs that have a role)
        for xx, rid in enumerate(rpred_ids):
            # indices
            # sentence e.g.
            bid = l2r[0][rid]
            # first element (trigger) we call it a1
            a1id = l2r[1][rid]
            # second element (trigger or entity) we call it a2
            a2id = l2r[2][rid]

            # rtype
            # role connecting pair e.g 16
            ...
            # if a1 is trigger and a2 it's not a trigger
            ...
            # if a2 is trigger and a1 it's not a trigger
    ...
    def generate_event_candidate_structures(self, etypes, tr_ids, l2r, rpred_types, rpred_ids
        ...
        # flat_rels_group it's a dictionary where the key is represented by a tuple
        # where the first element is the sentence and the second one the a1 id e.g (0,8)
        # >>> flat_rels_group[(0,8)]
        # [[11, 0, (12, 42), (0, 226)], [11, 2, (16, 46), (0, 358)]]
        # each object in flat_rels_group is a list of lists in the above example a list of 2 lists
        # each element in the list e.g. [11, 0, (12, 42), (0, 226)] has the following interpretation
        # - 11 is the index indicating the a1 entity type e.g (Positive_regulation, Localization, ...)
        # - 0 is the id of the pair
        # - 12 type of role connecting pair
        # - 42 is the index indicating the a2 entity type e.g (Positive_regulation, Localization, ...)
        # - 0 is the sentence
        # - 226 is the a2 id
        # we loop over all the relations != Other if consist of trigger-entity they end
        # in flat_rels_group, if they are trigger-trigger in nest_rels_group
        ...
        # there are triggers that can have no arguments such as (0, 8)
