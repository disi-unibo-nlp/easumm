...
def main():
    ...
    # checkpoint = torch.load('/Users/paoloitaliani/Downloads/train_weights_1_docs_second_exp_weights.pt', map_location=device)
    # deepee_model.load_state_dict(checkpoint['model_state_dict'], strict=False)
