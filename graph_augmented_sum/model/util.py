...
def sequence_loss(logits, targets, xent_fn, pad_idx: int):
    ...
    # - target is a tensors of size corresponding to the total number of
    #   tokens in the documents in the batch e.g (674,)
    # - logit is a tensor of size e.g. (674, vocab_size)
